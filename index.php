                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9 col-sm-pull-3 col-md-8 col-md-pull-4 col-lg-6 col-lg-pull-6 main-info">
                            ...
                            <p>Disfruta de un fin de semana diferente aprendiendo con <a href="#">Juan Pablo Pachar</a> y <a href="#">Junior Vásquez</a>.</p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-9 col-md-8 col-lg-6 main-info">
                            <h2>Desarrolla apliaciones multiplataforma con Adobe AIR</h2>
                            <p>Sorpréndete de lo fácil que puede ser crear apps para iOS y Android con este workshop impartido por <a href="#">Juan Pablo Pachar</a></p>
                            <a href="detail.php" class="more-info-link">quiero más información</a>
                            <a href="detail.php" class="btn btn-custom">ME APUNTO!</a>
                        </div>
                    </div>
